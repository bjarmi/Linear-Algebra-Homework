...
def add(u, v):
    ...
    Make sure to add together values for all keys from u.f and v.f even if some
    keys in u.f do not exist in v.f (or vice versa)
...
class Vec:
    ...
    __setitem__ = setitem
    __neg__ = neg
    __rmul__ = scalar_mul  # if left arg of * is primitive, assume scalar
